...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:net/java/games/input/DIDeviceObject.class */
final class DIDeviceObject {
    ...
    public final float convertValue(float value) {
        ...
        if (this.id == Component.Identifier.Axis.POV) {
            ...
            if ((int_value & LinuxKeycodes.XK_Delete) == 65535) {
                return 0.0f;
            }
            if (int_value >= 0 && int_value < 2250) {
                return 0.25f;
            }
            if (int_value < 3 * 2250) {
                return 0.375f;
            ...
            if (int_value < 11 * 2250) {
                return 0.875f;
            }
            if (int_value < 13 * 2250) {
                return 1.0f;
            }
            if (int_value < 15 * 2250) {
                return 0.125f;
            }
            return 0.25f;
        }
