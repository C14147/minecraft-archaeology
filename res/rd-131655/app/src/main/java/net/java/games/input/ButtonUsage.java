...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:net/java/games/input/ButtonUsage.class */
final class ButtonUsage implements Usage {
    ...
    public final String toString() {
        return new StringBuffer().append("ButtonUsage (").append(this.button_id).append(")").toString();
    }
}
