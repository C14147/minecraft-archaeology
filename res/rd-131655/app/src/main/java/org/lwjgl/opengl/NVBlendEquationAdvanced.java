...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/NVBlendEquationAdvanced.class */
public final class NVBlendEquationAdvanced {
    ...
    static native void nglBlendParameteriNV(int i, int i2, long j);

    static native void nglBlendBarrierNV(long j);
