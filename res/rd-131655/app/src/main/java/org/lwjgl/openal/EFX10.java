...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/openal/EFX10.class */
public final class EFX10 {
    ...
    static native void nalGenAuxiliaryEffectSlots(int i, long j);

    static native int nalGenAuxiliaryEffectSlots2(int i);

    static native void nalDeleteAuxiliaryEffectSlots(int i, long j);

    static native void nalDeleteAuxiliaryEffectSlots2(int i, int i2);

    static native boolean nalIsAuxiliaryEffectSlot(int i);

    static native void nalAuxiliaryEffectSloti(int i, int i2, int i3);

    static native void nalAuxiliaryEffectSlotiv(int i, int i2, long j);

    static native void nalAuxiliaryEffectSlotf(int i, int i2, float f);

    static native void nalAuxiliaryEffectSlotfv(int i, int i2, long j);

    static native int nalGetAuxiliaryEffectSloti(int i, int i2);

    static native void nalGetAuxiliaryEffectSlotiv(int i, int i2, long j);

    static native float nalGetAuxiliaryEffectSlotf(int i, int i2);

    static native void nalGetAuxiliaryEffectSlotfv(int i, int i2, long j);

    static native void nalGenEffects(int i, long j);

    static native int nalGenEffects2(int i);

    static native void nalDeleteEffects(int i, long j);

    static native void nalDeleteEffects2(int i, int i2);

    static native boolean nalIsEffect(int i);

    static native void nalEffecti(int i, int i2, int i3);

    static native void nalEffectiv(int i, int i2, long j);

    static native void nalEffectf(int i, int i2, float f);

    static native void nalEffectfv(int i, int i2, long j);

    static native int nalGetEffecti(int i, int i2);

    static native void nalGetEffectiv(int i, int i2, long j);

    static native float nalGetEffectf(int i, int i2);

    static native void nalGetEffectfv(int i, int i2, long j);

    static native void nalGenFilters(int i, long j);

    static native int nalGenFilters2(int i);

    static native void nalDeleteFilters(int i, long j);

    static native void nalDeleteFilters2(int i, int i2);

    static native boolean nalIsFilter(int i);

    static native void nalFilteri(int i, int i2, int i3);

    static native void nalFilteriv(int i, int i2, long j);

    static native void nalFilterf(int i, int i2, float f);

    static native void nalFilterfv(int i, int i2, long j);

    static native int nalGetFilteri(int i, int i2);

    static native void nalGetFilteriv(int i, int i2, long j);

    static native float nalGetFilterf(int i, int i2);

    static native void nalGetFilterfv(int i, int i2, long j);
