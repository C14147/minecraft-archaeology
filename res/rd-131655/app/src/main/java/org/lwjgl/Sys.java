...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/Sys.class */
public final class Sys {
    ...
    public static boolean openURL(String url) {
        try {
            ...
            Method lookupMethod = (Method) AccessController.doPrivileged(new PrivilegedExceptionAction<Method>() { // from class: org.lwjgl.Sys.2
            ...
            Method showDocumentMethod = (Method) AccessController.doPrivileged(new PrivilegedExceptionAction<Method>() { // from class: org.lwjgl.Sys.3
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // java.security.PrivilegedExceptionAction
                public Method run() throws Exception {
