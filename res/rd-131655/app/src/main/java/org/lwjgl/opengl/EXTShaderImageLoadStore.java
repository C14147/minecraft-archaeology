...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/EXTShaderImageLoadStore.class */
public final class EXTShaderImageLoadStore {
    ...
    static native void nglBindImageTextureEXT(int i, int i2, int i3, boolean z, int i4, int i5, int i6, long j);

    static native void nglMemoryBarrierEXT(int i, long j);
