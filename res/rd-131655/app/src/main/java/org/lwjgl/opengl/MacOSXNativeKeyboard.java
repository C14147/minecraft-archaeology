...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/MacOSXNativeKeyboard.class */
final class MacOSXNativeKeyboard extends EventQueue {
    ...
    private int getMappedKeyCode(short key_code) {
        if (this.nativeToLwjglMap.containsKey(Short.valueOf(key_code))) {
            return this.nativeToLwjglMap.get(Short.valueOf(key_code)).intValue();
        }
        return -1;
    }
