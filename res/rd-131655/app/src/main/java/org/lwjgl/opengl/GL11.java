...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/GL11.class */
public final class GL11 {
    ...
    public static void glCallLists(ByteBuffer lists) {
        ...
        nglCallLists(lists.remaining(), GL_UNSIGNED_BYTE, MemoryUtil.getAddress(lists), function_pointer);
    }
    ...
    public static void glCallLists(IntBuffer lists) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(lists);
        nglCallLists(lists.remaining(), GL_UNSIGNED_INT, MemoryUtil.getAddress(lists), function_pointer);
    }
    ...
    public static void glCallLists(ShortBuffer lists) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(lists);
        nglCallLists(lists.remaining(), GL_UNSIGNED_SHORT, MemoryUtil.getAddress(lists), function_pointer);
    }
    ...
    public static void glColorPointer(int size, int stride, DoubleBuffer pointer) {
        ...
        nglColorPointer(size, GL_DOUBLE, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glColorPointer(int size, int stride, FloatBuffer pointer) {
        ...
        nglColorPointer(size, GL_FLOAT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glColorPointer(int size, boolean unsigned, int stride, ByteBuffer pointer) {
        ...
        nglColorPointer(size, unsigned ? GL_UNSIGNED_BYTE : GL_BYTE, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glDrawElements(int mode, ByteBuffer indices) {
        ...
        nglDrawElements(mode, indices.remaining(), GL_UNSIGNED_BYTE, MemoryUtil.getAddress(indices), function_pointer);
    }
    ...
    public static void glDrawElements(int mode, IntBuffer indices) {
        ...
        GLChecks.ensureElementVBOdisabled(caps);
        BufferChecks.checkDirect(indices);
        nglDrawElements(mode, indices.remaining(), GL_UNSIGNED_INT, MemoryUtil.getAddress(indices), function_pointer);
    }
    ...
    public static void glDrawElements(int mode, ShortBuffer indices) {
        ...
        GLChecks.ensureElementVBOdisabled(caps);
        BufferChecks.checkDirect(indices);
        nglDrawElements(mode, indices.remaining(), GL_UNSIGNED_SHORT, MemoryUtil.getAddress(indices), function_pointer);
    }
    ...
    public static void glNormalPointer(int stride, ByteBuffer pointer) {
        ...
        nglNormalPointer(GL_BYTE, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glNormalPointer(int stride, DoubleBuffer pointer) {
        ...
        nglNormalPointer(GL_DOUBLE, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glNormalPointer(int stride, FloatBuffer pointer) {
        ...
        nglNormalPointer(GL_FLOAT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glNormalPointer(int stride, IntBuffer pointer) {
        ...
        nglNormalPointer(GL_INT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glVertexPointer(int size, int stride, DoubleBuffer pointer) {
        ...
        nglVertexPointer(size, GL_DOUBLE, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glVertexPointer(int size, int stride, FloatBuffer pointer) {
        ...
        nglVertexPointer(size, GL_FLOAT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glVertexPointer(int size, int stride, IntBuffer pointer) {
        ...
        nglVertexPointer(size, GL_INT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glVertexPointer(int size, int stride, ShortBuffer pointer) {
        ...
        nglVertexPointer(size, GL_SHORT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glTexCoordPointer(int size, int stride, DoubleBuffer pointer) {
        ...
        nglTexCoordPointer(size, GL_DOUBLE, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glTexCoordPointer(int size, int stride, FloatBuffer pointer) {
        ...
        nglTexCoordPointer(size, GL_FLOAT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glTexCoordPointer(int size, int stride, IntBuffer pointer) {
        ...
        nglTexCoordPointer(size, GL_INT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
    ...
    public static void glTexCoordPointer(int size, int stride, ShortBuffer pointer) {
        ...
        nglTexCoordPointer(size, GL_SHORT, stride, MemoryUtil.getAddress(pointer), function_pointer);
    }
