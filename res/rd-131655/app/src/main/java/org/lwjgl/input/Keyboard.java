...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/input/Keyboard.class */
public class Keyboard {
    ...
    public static synchronized int getKeyIndex(String keyName2) {
        Integer ret = keyMap.get(keyName2);
        if (ret == null) {
            return 0;
        }
        return ret.intValue();
    ...
    /* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/input/Keyboard$KeyEvent.class */
