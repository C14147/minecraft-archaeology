...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/LinuxKeycodes.class */
final class LinuxKeycodes {
    ...
    public static int mapKeySymToLWJGLKeyCode(long keysym) {
        switch ((int) keysym) {
            ...
            case 96:
                return 41;
            case XK_ISO_Level3_Shift /* 65027 */:
            case XK_Meta_R /* 65512 */:
                return 184;
            case XK_ISO_Left_Tab /* 65056 */:
            case XK_Tab /* 65289 */:
                return 15;
            case XK_dead_grave /* 65104 */:
                return 41;
            case XK_dead_circumflex /* 65106 */:
                return 144;
            ...
            case XK_Pause /* 65299 */:
                return 197;
            case XK_Scroll_Lock /* 65300 */:
                return 70;
            case XK_Sys_Req /* 65301 */:
                return 183;
            case XK_Escape /* 65307 */:
                return 1;
            case XK_Kanji /* 65313 */:
                return 148;
            case XK_Home /* 65360 */:
            ...
            case XK_End /* 65367 */:
                return 207;
            case XK_Insert /* 65379 */:
                return 210;
            case XK_Break /* 65387 */:
                return 197;
            case XK_Num_Lock /* 65407 */:
                return 69;
            case XK_KP_Space /* 65408 */:
                return 57;
            case XK_KP_Tab /* 65417 */:
                return 15;
            case XK_KP_Enter /* 65421 */:
                return 156;
            case XK_KP_F1 /* 65425 */:
                return 59;
            case XK_KP_F2 /* 65426 */:
            ...
            case XK_KP_F4 /* 65428 */:
                return 62;
            case XK_KP_Home /* 65429 */:
                return 199;
            case XK_KP_Left /* 65430 */:
                return 203;
            case XK_KP_Up /* 65431 */:
                return 200;
            case XK_KP_Right /* 65432 */:
                return 205;
            case XK_KP_Down /* 65433 */:
                return 208;
            case 65434:
                return 201;
            case 65435:
                return 209;
            case XK_KP_End /* 65436 */:
                return 207;
            case XK_KP_Insert /* 65438 */:
                return 210;
            case XK_KP_Delete /* 65439 */:
                return 211;
            case XK_KP_Multiply /* 65450 */:
                return 55;
            case XK_KP_Add /* 65451 */:
                return 78;
            case XK_KP_Subtract /* 65453 */:
                return 74;
            case XK_KP_Decimal /* 65454 */:
                return 83;
            case XK_KP_Divide /* 65455 */:
                return 181;
            case XK_KP_0 /* 65456 */:
                return 82;
            case XK_KP_1 /* 65457 */:
