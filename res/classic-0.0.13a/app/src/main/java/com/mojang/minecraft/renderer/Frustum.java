...
/* JADX INFO: loaded from: client.jar:com/mojang/minecraft/renderer/Frustum.class */
public class Frustum {
    ...
    public static final int f60B = 1;

    /* JADX INFO: renamed from: C */
    public static final int f61C = 2;

    /* JADX INFO: renamed from: D */
    public static final int f62D = 3;
    ...
    private void normalizePlane(float[][] frustum2, int side) {
    ...
    public boolean isVisible(AABB aabb) {
        return cubeInFrustum(aabb.f53x0, aabb.f54y0, aabb.f55z0, aabb.f56x1, aabb.f57y1, aabb.f58z1);
    }
}
