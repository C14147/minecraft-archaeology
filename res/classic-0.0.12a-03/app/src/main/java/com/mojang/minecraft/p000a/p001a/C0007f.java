...
/* JADX INFO: loaded from: Classic 0.0.12a 03.jar:com/mojang/minecraft/a/a/f.class */
public final class C0007f extends C0003b {
    ...
    public final void mo2a(C0013g c0013g, int i, int i2, int i3, Random random) {
        ...
        if (!c0013g.m41a(i, i2 + 1, i3)) {
            c0013g.m38a(i, i2, i3, C0003b.f17e.f24l);
            return;
        }
        for (int i4 = 0; i4 < 4; i4++) {
            ...
            if (c0013g.m42b(iNextInt, iNextInt2, iNextInt3) == C0003b.f17e.f24l && c0013g.m41a(iNextInt, iNextInt2 + 1, iNextInt3)) {
                c0013g.m38a(iNextInt, iNextInt2, iNextInt3, C0003b.f16d.f24l);
            }
        }
    }
}
