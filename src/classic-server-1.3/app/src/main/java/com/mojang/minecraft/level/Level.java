...
public class Level implements Serializable {
    ...
    public ArrayList getCubes(AABB aabb) {
        ...
        int i = (int) aabb.f95x0;
        int i2 = ((int) aabb.f98x1) + 1;
        int i3 = (int) aabb.f96y0;
        int i4 = ((int) aabb.f99y1) + 1;
        int i5 = (int) aabb.f97z0;
        int i6 = ((int) aabb.f100z1) + 1;
        if (aabb.f95x0 < 0.0f) {
            i--;
        }
        if (aabb.f96y0 < 0.0f) {
            ...
            for (int i8 = i3; i8 < i4; i8++) {
                for (int i9 = i5; i9 < i6; i9++) {
                    if (i7 >= 0 && i8 >= 0 && i9 >= 0 && i7 < this.width && i8 < this.depth && i9 < this.height) {
                        ...
                        if (c0008b != null && (aabbMo10a2 = c0008b.mo10a(i7, i8, i9)) != null) {
                            arrayList.add(aabbMo10a2);
                        }
                    } else if ((i7 < 0 || i8 < 0 || i9 < 0 || i7 >= this.width || i9 >= this.height) && (aabbMo10a = C0008b.f58i.mo10a(i7, i8, i9)) != null) {
    ...
    public boolean setTileNoNeighborChange(int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < this.f43a.size(); i5++) {
            ((MinecraftServer) this.f43a.get(i5)).m42a(i, i2, i3);
        }
        return true;
    }
    ...
    public void tick() {
        ...
        if (this.tickCount % 5 == 0) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                C0016b c0016b = (C0016b) this.f47e.remove(0);
                if (c0016b.f78e > 0) {
                    c0016b.f78e--;
                    this.f47e.add(c0016b);
                } else if (m5a(c0016b.f74a, c0016b.f75b, c0016b.f76c) && (b = this.blocks[(((c0016b.f75b * this.height) + c0016b.f76c) * this.width) + c0016b.f74a]) == c0016b.f77d && b > 0) {
                    C0008b.f49a[b].mo9a(this, c0016b.f74a, c0016b.f75b, c0016b.f76c, this.f45c);
                }
            }
        }
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            if (C0008b.f50b[b2]) {
                C0008b.f49a[b2].mo9a(this, i10, i12, i11, this.f45c);
            }
        }
    }
    ...
    public boolean containsAnyLiquid(AABB aabb) {
        ...
        for (int i7 = i; i7 < i2; i7++) {
            for (int i8 = i3; i8 < i4; i8++) {
                for (int i9 = i5; i9 < i6; i9++) {
                    C0008b c0008b = C0008b.f49a[getTile(i7, i8, i9)];
                    if (c0008b != null && c0008b.mo15c() != C0022a.f92a) {
                        return true;
                    }
                }
            }
    ...
    public boolean containsLiquid(AABB aabb, C0022a c0022a) {
        int i = (int) aabb.f95x0;
        int i2 = ((int) aabb.f98x1) + 1;
        int i3 = (int) aabb.f96y0;
        int i4 = ((int) aabb.f99y1) + 1;
        ...
        for (int i7 = i; i7 < i2; i7++) {
            for (int i8 = i3; i8 < i4; i8++) {
                for (int i9 = i5; i9 < i6; i9++) {
                    C0008b c0008b = C0008b.f49a[getTile(i7, i8, i9)];
                    if (c0008b != null && c0008b.mo15c() == c0022a) {
                        return true;
                    }
                }
            }
    ...
    public void addToTickNextTick(int i, int i2, int i3, int i4) {
        ...
        if (i4 > 0) {
            c0016b.f78e = C0008b.f49a[i4].mo18d();
        }
        this.f47e.add(c0016b);
    }
    ...
    private boolean m6a(float f, float f2, float f3) {
        ...
        return tile > 0 && C0008b.f49a[tile].mo12b();
    }

    public int getHighestTile(int i, int i2) {
        int i3 = this.depth;
        while (true) {
            if ((getTile(i, i3 - 1, i2) != 0 && C0008b.f49a[getTile(i, i3 - 1, i2)].mo15c() == C0022a.f92a) || i3 <= 0) {
                break;
            }
            i3--;
        }
