...
public final class C0015i extends C0008b {
    protected C0015i(int i) {
        super(2);
        m13a(true);
    }
    ...
    public final void mo9a(Level level, int i, int i2, int i3, Random random) {
        ...
        if (!level.isLit(i, i2 + 1, i3)) {
            level.setTile(i, i2, i3, C0008b.f54e.f70u);
            return;
        }
        for (int i4 = 0; i4 < 4; i4++) {
            ...
            if (level.getTile(iNextInt, iNextInt2, iNextInt3) == C0008b.f54e.f70u && level.isLit(iNextInt, iNextInt2 + 1, iNextInt3)) {
                level.setTile(iNextInt, iNextInt2, iNextInt3, C0008b.f53d.f70u);
            }
        }
    }
}
