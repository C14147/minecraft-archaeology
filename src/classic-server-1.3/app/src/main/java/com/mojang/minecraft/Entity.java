...
public class Entity implements Serializable {
    ...
    public void move(float f, float f2, float f3) {
        ...
        this.f15x = (this.f21bb.f95x0 + this.f21bb.f98x1) / 2.0f;
        this.f16y = this.f21bb.f96y0 + this.heightOffset;
        this.f17z = (this.f21bb.f97z0 + this.f21bb.f100z1) / 2.0f;
    }

    public boolean isInWater() {
        return this.level.containsLiquid(this.f21bb.grow(0.0f, -0.4f, 0.0f), C0022a.f93b);
    }

    public boolean isInLava() {
        return this.level.containsLiquid(this.f21bb.grow(0.0f, -0.4f, 0.0f), C0022a.f94c);
    }
