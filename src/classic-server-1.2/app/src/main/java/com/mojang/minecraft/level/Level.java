...
public class Level implements Serializable {
    ...
    private transient int[] f43b;

    /* JADX INFO: renamed from: a */
    private transient ArrayList f42a = new ArrayList();

    /* JADX INFO: renamed from: c */
    private transient Random f44c = new Random();

    /* JADX INFO: renamed from: d */
    private transient int f45d = this.f44c.nextInt();

    /* JADX INFO: renamed from: e */
    private transient ArrayList f46e = new ArrayList();
    ...
    public void initTransient() {
        ...
        this.f43b = new int[this.width * this.height];
        Arrays.fill(this.f43b, this.depth);
        calcLightDepths(0, 0, this.width, this.height);
        this.f44c = new Random();
        this.f45d = this.f44c.nextInt();
    ...
    public void setData(int i, int i2, int i3, byte[] bArr) {
        ...
        this.depth = i2;
        this.blocks = bArr;
        this.f43b = new int[i * i3];
        Arrays.fill(this.f43b, this.depth);
        calcLightDepths(0, 0, i, i3);
        for (int i4 = 0; i4 < this.f42a.size(); i4++) {
            this.f42a.get(i4);
        }
        this.f46e.clear();
        findSpawn();
    ...
    public void calcLightDepths(int i, int i2, int i3, int i4) {
        for (int i5 = i; i5 < i + i3; i5++) {
            for (int i6 = i2; i6 < i2 + i4; i6++) {
                int i7 = this.f43b[i5 + (i6 * this.width)];
                int i8 = this.depth - 1;
                while (i8 > 0 && !isLightBlocker(i5, i8, i6)) {
                    i8--;
                }
                this.f43b[i5 + (i6 * this.width)] = i8 + 1;
                if (i7 != i8) {
                    for (int i9 = 0; i9 < this.f42a.size(); i9++) {
                        this.f42a.get(i9);
                    }
                }
            }
    ...
    public void removeListener$74652038(MinecraftServer minecraftServer) {
        this.f42a.remove(minecraftServer);
    }

    public boolean isLightBlocker(int i, int i2, int i3) {
        C0007b c0007b = C0007b.f48a[getTile(i, i2, i3)];
        if (c0007b == null) {
            return false;
        }
        return c0007b.mo11a();
    ...
    public ArrayList getCubes(AABB aabb) {
        ...
        int i = (int) aabb.f91x0;
        int i2 = ((int) aabb.f94x1) + 1;
        int i3 = (int) aabb.f92y0;
        int i4 = ((int) aabb.f95y1) + 1;
        int i5 = (int) aabb.f93z0;
        int i6 = ((int) aabb.f96z1) + 1;
        if (aabb.f91x0 < 0.0f) {
            i--;
        }
        if (aabb.f92y0 < 0.0f) {
            ...
            for (int i8 = i3; i8 < i4; i8++) {
                for (int i9 = i5; i9 < i6; i9++) {
                    if (i7 >= 0 && i8 >= 0 && i9 >= 0 && i7 < this.width && i8 < this.depth && i9 < this.height) {
                        C0007b c0007b = C0007b.f48a[getTile(i7, i8, i9)];
                        if (c0007b != null && (aabbMo10a2 = c0007b.mo10a(i7, i8, i9)) != null) {
                            arrayList.add(aabbMo10a2);
                        }
                    } else if ((i7 < 0 || i8 < 0 || i9 < 0 || i7 >= this.width || i9 >= this.height) && (aabbMo10a = C0007b.f54f.mo10a(i7, i8, i9)) != null) {
                        arrayList.add(aabbMo10a);
                    }
                }
            }
        }
    ...
    public boolean setTileNoNeighborChange(int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < this.f42a.size(); i5++) {
            ((MinecraftServer) this.f42a.get(i5)).m41a(i, i2, i3);
        }
        return true;
    }
    ...
    /* JADX INFO: renamed from: b */
    private void m4b(int i, int i2, int i3, int i4) {
        C0007b c0007b;
        if (i < 0 || i2 < 0 || i3 < 0 || i >= this.width || i2 >= this.depth || i3 >= this.height || (c0007b = C0007b.f48a[this.blocks[(((i2 * this.height) + i3) * this.width) + i]]) == null) {
            return;
        }
        c0007b.mo16a(this, i, i2, i3, i4);
    }

    public boolean isLit(int i, int i2, int i3) {
        return i < 0 || i2 < 0 || i3 < 0 || i >= this.width || i2 >= this.depth || i3 >= this.height || i2 >= this.f43b[i + (i3 * this.width)];
    }
    ...
    public void tick() {
        ...
        if (this.tickCount % 5 == 0) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                C0015b c0015b = (C0015b) this.f46e.remove(0);
                if (c0015b.f74e > 0) {
                    c0015b.f74e--;
                    this.f46e.add(c0015b);
                } else if (m5a(c0015b.f70a, c0015b.f71b, c0015b.f72c) && (b = this.blocks[(((c0015b.f71b * this.height) + c0015b.f72c) * this.width) + c0015b.f70a]) == c0015b.f73d && b > 0) {
                    C0007b.f48a[b].mo9a(this, c0015b.f70a, c0015b.f71b, c0015b.f72c, this.f44c);
                }
            }
        }
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            this.f45d = (this.f45d * 3) + 1013904223;
            int i9 = this.f45d >> 2;
            int i10 = i9 & i4;
            int i11 = (i9 >> i) & i3;
            int i12 = (i9 >> (i + i2)) & i5;
            ...
            if (C0007b.f49b[b2]) {
                C0007b.f48a[b2].mo9a(this, i10, i12, i11, this.f44c);
            }
        }
    }

    /* JADX INFO: renamed from: a */
    private boolean m5a(int i, int i2, int i3) {
    ...
    public boolean containsAnyLiquid(AABB aabb) {
        ...
        for (int i7 = i; i7 < i2; i7++) {
            for (int i8 = i3; i8 < i4; i8++) {
                for (int i9 = i5; i9 < i6; i9++) {
                    C0007b c0007b = C0007b.f48a[getTile(i7, i8, i9)];
                    if (c0007b != null && c0007b.mo15c() != C0021a.f88a) {
                        return true;
                    }
                }
            }
    ...
    public boolean containsLiquid(AABB aabb, C0021a c0021a) {
        int i = (int) aabb.f91x0;
        int i2 = ((int) aabb.f94x1) + 1;
        int i3 = (int) aabb.f92y0;
        int i4 = ((int) aabb.f95y1) + 1;
        ...
        for (int i7 = i; i7 < i2; i7++) {
            for (int i8 = i3; i8 < i4; i8++) {
                for (int i9 = i5; i9 < i6; i9++) {
                    C0007b c0007b = C0007b.f48a[getTile(i7, i8, i9)];
                    if (c0007b != null && c0007b.mo15c() == c0021a) {
                        return true;
                    }
                }
            }
    ...
    public void addToTickNextTick(int i, int i2, int i3, int i4) {
        C0015b c0015b = new C0015b(i, i2, i3, i4);
        if (i4 > 0) {
            c0015b.f74e = C0007b.f48a[i4].mo18d();
        }
        this.f46e.add(c0015b);
    }
    ...
    public boolean isSolid(float f, float f2, float f3, float f4) {
        return m6a(f - f4, f2 - f4, f3 - f4) || m6a(f - f4, f2 - f4, f3 + f4) || m6a(f - f4, f2 + f4, f3 - f4) || m6a(f - f4, f2 + f4, f3 + f4) || m6a(f + f4, f2 - f4, f3 - f4) || m6a(f + f4, f2 - f4, f3 + f4) || m6a(f + f4, f2 + f4, f3 - f4) || m6a(f + f4, f2 + f4, f3 + f4);
    }

    /* JADX INFO: renamed from: a */
    private boolean m6a(float f, float f2, float f3) {
        int tile = getTile((int) f, (int) f2, (int) f3);
        return tile > 0 && C0007b.f48a[tile].mo12b();
    }

    public int getHighestTile(int i, int i2) {
        int i3 = this.depth;
        while (true) {
            if ((getTile(i, i3 - 1, i2) != 0 && C0007b.f48a[getTile(i, i3 - 1, i2)].mo15c() == C0021a.f88a) || i3 <= 0) {
                break;
            }
            i3--;
        }
    ...
    public float getCaveness(float f, float f2, float f3, float f4) {
        ...
        for (int i4 = i - 6; i4 <= i + 6; i4++) {
            for (int i5 = i3 - 6; i5 <= i3 + 6; i5++) {
                if (m5a(i4, i2, i5) && !isSolidTile(i4, i2, i5)) {
                    float f8 = (i5 + 0.5f) - f3;
