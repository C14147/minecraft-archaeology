...
import com.mojang.minecraft.p001a.C0003b;
import com.mojang.minecraft.p002b.InterfaceC0004a;
...
public class Entity implements Serializable {
    ...
    protected void setPos(C0003b c0003b) {
    ...
    public void move(float f, float f2, float f3) {
        ...
        this.f15x = (this.f21bb.f91x0 + this.f21bb.f94x1) / 2.0f;
        this.f16y = this.f21bb.f92y0 + this.heightOffset;
        this.f17z = (this.f21bb.f93z0 + this.f21bb.f96z1) / 2.0f;
    }

    public boolean isInWater() {
        return this.level.containsLiquid(this.f21bb.grow(0.0f, -0.4f, 0.0f), C0021a.f89b);
    }

    public boolean isInLava() {
        return this.level.containsLiquid(this.f21bb.grow(0.0f, -0.4f, 0.0f), C0021a.f90c);
    }
    ...
    public void render(InterfaceC0004a interfaceC0004a, float f) {
    }
