...
/* JADX INFO: loaded from: c0.0.16a_02.jar:com/mojang/minecraft/a/a.class */
public class C0003a {
    ...
    /* JADX INFO: renamed from: a */
    public final int m4a(String str, int i) {
        try {
            if (this.f20a.containsKey(str)) {
                return ((Integer) this.f20a.get(str)).intValue();
            }
            ...
            this.f20a.put(str, Integer.valueOf(i2));
