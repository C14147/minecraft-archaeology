...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:net/java/games/input/GenericDesktopUsage.class */
final class GenericDesktopUsage implements Usage {
    ...
    public static final GenericDesktopUsage SYSTEM_MENU_EXIT = new GenericDesktopUsage(NativeDefinitions.KEY_FIND);
    public static final GenericDesktopUsage SYSTEM_MENU = new GenericDesktopUsage(NativeDefinitions.KEY_CUT);
    public static final GenericDesktopUsage SYSTEM_MENU_RIGHT = new GenericDesktopUsage(NativeDefinitions.KEY_HELP);
    public static final GenericDesktopUsage SYSTEM_MENU_LEFT = new GenericDesktopUsage(NativeDefinitions.KEY_MENU);
    public static final GenericDesktopUsage SYSTEM_MENU_UP = new GenericDesktopUsage(NativeDefinitions.KEY_CALC);
    ...
    public final String toString() {
        return new StringBuffer().append("GenericDesktopUsage (0x").append(Integer.toHexString(this.usage_id)).append(")").toString();
    }
