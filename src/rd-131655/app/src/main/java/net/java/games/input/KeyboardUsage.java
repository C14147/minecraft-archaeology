...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:net/java/games/input/KeyboardUsage.class */
final class KeyboardUsage implements Usage {
    ...
    public static final KeyboardUsage INTERNATIONAL2 = new KeyboardUsage(NativeDefinitions.KEY_FIND);
    public static final KeyboardUsage INTERNATIONAL3 = new KeyboardUsage(NativeDefinitions.KEY_CUT);
    public static final KeyboardUsage INTERNATIONAL4 = new KeyboardUsage(NativeDefinitions.KEY_HELP);
    public static final KeyboardUsage INTERNATIONAL5 = new KeyboardUsage(NativeDefinitions.KEY_MENU);
    public static final KeyboardUsage INTERNATIONAL6 = new KeyboardUsage(NativeDefinitions.KEY_CALC);
    public static final KeyboardUsage INTERNATIONAL7 = new KeyboardUsage(141);
    public static final KeyboardUsage INTERNATIONAL8 = new KeyboardUsage(NativeDefinitions.KEY_SLEEP);
    public static final KeyboardUsage INTERNATIONAL9 = new KeyboardUsage(NativeDefinitions.KEY_WAKEUP);
    ...
    public static final KeyboardUsage LANG9 = new KeyboardUsage(NativeDefinitions.KEY_COFFEE);
    public static final KeyboardUsage ALTERNATEERASE = new KeyboardUsage(153);
    public static final KeyboardUsage SYSREQORATTENTION = new KeyboardUsage(Component.Identifier.Key.SYSRQ, NativeDefinitions.KEY_CYCLEWINDOWS);
    public static final KeyboardUsage CANCEL = new KeyboardUsage(NativeDefinitions.KEY_MAIL);
    ...
    public static final KeyboardUsage RETURN = new KeyboardUsage(Component.Identifier.Key.RETURN, NativeDefinitions.KEY_BACK);
    public static final KeyboardUsage SEPARATOR = new KeyboardUsage(NativeDefinitions.KEY_FORWARD);
    ...
    public final String toString() {
        return new StringBuffer().append("KeyboardUsage (0x").append(Integer.toHexString(this.usage)).append(")").toString();
    }
}
