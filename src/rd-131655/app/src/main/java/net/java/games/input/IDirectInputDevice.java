...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:net/java/games/input/IDirectInputDevice.class */
final class IDirectInputDevice {
    ...
    public IDirectInputDevice(DummyWindow window, long address, byte[] instance_guid, byte[] product_guid, int dev_type, int dev_subtype, String instance_name, String product_name) throws Throwable {
        this.window = window;
        ...
        try {
            ...
            DirectInputEnvironmentPlugin.logln(new StringBuffer().append("Failed to create rumblers: ").append(e.getMessage()).toString());
        }
    ...
    private final Rumbler createPeriodicRumbler(DIDeviceObject[] axes, long[] directions, DIEffectInfo info) throws IOException {
        ...
        long effect_address = nCreatePeriodicEffect(this.address, info.getGUID(), 17, -1, 0, DI_FFNOMINALMAX, -1, 0, axis_ids, directions, 0, 0, 0, 0, DI_FFNOMINALMAX, 0, 0, 50000, 0);
    ...
    private final void poll() throws IOException {
        ...
        if (res != 0 && res != 1) {
            ...
            throw new IOException(new StringBuffer().append("Failed to poll device (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
    ...
    private final void acquire() throws IOException {
        ...
        if (res != 0 && res != -2147024891 && res != 1) {
            throw new IOException(new StringBuffer().append("Failed to acquire device (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
    ...
    private final void unacquire() throws IOException {
        ...
        if (res != 0 && res != 1) {
            throw new IOException(new StringBuffer().append("Failed to unAcquire device (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
    ...
    private final boolean getDeviceData(DataQueue queue) throws IOException {
        ...
        if (res != 0 && res != 1) {
            ...
            throw new IOException(new StringBuffer().append("Failed to get device data (").append(Integer.toHexString(res)).append(")").toString());
        }
        return true;
    }
    ...
    private final void getDeviceState(int[] device_state) throws IOException {
        ...
        if (res != 0) {
            ...
            throw new IOException(new StringBuffer().append("Failed to get device state (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
    ...
    private final void setDataFormat(int flags) throws IOException {
        ...
        if (res != 0) {
            throw new IOException(new StringBuffer().append("Failed to set data format (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
    ...
    private final void enumEffects() throws IOException {
        ...
        if (res != 0) {
            throw new IOException(new StringBuffer().append("Failed to enumerate effects (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
    ...
    private final void enumObjects() throws IOException {
        ...
        if (res != 0) {
            throw new IOException(new StringBuffer().append("Failed to enumerate objects (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
    ...
    public final synchronized long[] getRangeProperty(int object_identifier) throws IOException {
        ...
        if (res != 0) {
            throw new IOException(new StringBuffer().append("Failed to get object range (").append(res).append(")").toString());
        }
        return range;
    }
    ...
    private final void addObject(byte[] guid, int guid_type, int identifier, int type, int instance, int flags, String name) throws IOException {
        ...
        this.current_format_offset = format_offset + 1;
    ...
    private final Component.Identifier.Button getNextButtonIdentifier() {
        ...
        this.button_counter = button_id + 1;
    ...
    public final synchronized void setBufferSize(int size) throws Throwable {
        Class clsClass$;
        checkReleased();
        unacquire();
        int res = nSetBufferSize(this.address, size);
        if (res != 0 && res != 1 && res != 2) {
            throw new IOException(new StringBuffer().append("Failed to set buffer size (").append(Integer.toHexString(res)).append(")").toString());
        }
        if (class$net$java$games$input$DIDeviceObjectData == null) {
            clsClass$ = class$("net.java.games.input.DIDeviceObjectData");
            class$net$java$games$input$DIDeviceObjectData = clsClass$;
        } else {
            clsClass$ = class$net$java$games$input$DIDeviceObjectData;
        }
        this.queue = new DataQueue(size, clsClass$);
    ...
    public final synchronized void setCooperativeLevel(int flags) throws IOException {
        ...
        if (res != 0) {
            throw new IOException(new StringBuffer().append("Failed to set cooperative level (").append(Integer.toHexString(res)).append(")").toString());
        }
    }
