...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:net/java/games/input/RawDevice.class */
final class RawDevice {
    ...
    public RawDevice(RawInputEventQueue queue, long handle, int type) throws Throwable {
        this.queue = queue;
        this.handle = handle;
        this.type = type;
        setBufferSize(32);
    ...
    private final boolean processMouseEvent(RawMouseEvent event) {
        ...
        boolean has_update = updateButtonState(0, button_flags, 1, 2) || 0 != 0;
        boolean has_update2 = updateButtonState(1, button_flags, 4, 8) || has_update;
        boolean has_update3 = updateButtonState(2, button_flags, 16, 32) || has_update2;
        boolean has_update4 = updateButtonState(3, button_flags, 64, 128) || has_update3;
        boolean has_update5 = updateButtonState(4, button_flags, 256, 512) || has_update4;
        ...
        this.relative_y += dy;
        this.wheel += dwheel;
        boolean has_update6 = (dx == 0 && dy == 0 && dwheel == 0 && !has_update5) ? false : true;
        return has_update6;
    }
    ...
    public final void setBufferSize(int size) throws Throwable {
        Class clsClass$;
        Class clsClass$2;
        Class clsClass$3;
        Class clsClass$4;
        if (class$net$java$games$input$RawKeyboardEvent == null) {
            clsClass$ = class$("net.java.games.input.RawKeyboardEvent");
            class$net$java$games$input$RawKeyboardEvent = clsClass$;
        } else {
            clsClass$ = class$net$java$games$input$RawKeyboardEvent;
        }
        this.keyboard_events = new DataQueue(size, clsClass$);
        if (class$net$java$games$input$RawMouseEvent == null) {
            clsClass$2 = class$("net.java.games.input.RawMouseEvent");
            class$net$java$games$input$RawMouseEvent = clsClass$2;
        } else {
            clsClass$2 = class$net$java$games$input$RawMouseEvent;
        }
        this.mouse_events = new DataQueue(size, clsClass$2);
        if (class$net$java$games$input$RawKeyboardEvent == null) {
            clsClass$3 = class$("net.java.games.input.RawKeyboardEvent");
            class$net$java$games$input$RawKeyboardEvent = clsClass$3;
        } else {
            clsClass$3 = class$net$java$games$input$RawKeyboardEvent;
        }
        this.processed_keyboard_events = new DataQueue(size, clsClass$3);
        if (class$net$java$games$input$RawMouseEvent == null) {
            clsClass$4 = class$("net.java.games.input.RawMouseEvent");
            class$net$java$games$input$RawMouseEvent = clsClass$4;
        } else {
            clsClass$4 = class$net$java$games$input$RawMouseEvent;
        }
        this.processed_mouse_events = new DataQueue(size, clsClass$4);
    }
