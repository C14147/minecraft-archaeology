...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opencl/CLCapabilities.class */
public final class CLCapabilities {
    ...
    public static CLPlatformCapabilities getPlatformCapabilities(CLPlatform platform) {
        ...
        if (caps == null) {
            CLPlatformCapabilities cLPlatformCapabilities = new CLPlatformCapabilities(platform);
            caps = cLPlatformCapabilities;
            platform.setCapabilities(cLPlatformCapabilities);
        }
        return caps;
    }
    ...
    public static CLDeviceCapabilities getDeviceCapabilities(CLDevice device) {
        ...
        if (caps == null) {
            CLDeviceCapabilities cLDeviceCapabilities = new CLDeviceCapabilities(device);
            caps = cLDeviceCapabilities;
            device.setCapabilities(cLDeviceCapabilities);
        }
        return caps;
    }
