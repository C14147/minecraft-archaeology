...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/AWTUtil.class */
final class AWTUtil {
    AWTUtil() {
    }
    ...
    private static Point getPointerLocation(Component component) {
        try {
            ...
            if (config != null) {
                PointerInfo pointer_info = (PointerInfo) AccessController.doPrivileged(new PrivilegedExceptionAction<PointerInfo>() { // from class: org.lwjgl.opengl.AWTUtil.2
                    /* JADX WARN: Can't rename method to resolve collision */
                    @Override // java.security.PrivilegedExceptionAction
    ...
    public static int getMaxCursorSize() {
        Dimension max_size = Toolkit.getDefaultToolkit().getBestCursorSize(IDirectInputDevice.DI_FFNOMINALMAX, IDirectInputDevice.DI_FFNOMINALMAX);
