...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opencl/CLPlatformCapabilities.class */
public class CLPlatformCapabilities {
    ...
    public CLPlatformCapabilities(CLPlatform platform) {
        String extensionList = platform.getInfoString(CL10.CL_PLATFORM_EXTENSIONS);
