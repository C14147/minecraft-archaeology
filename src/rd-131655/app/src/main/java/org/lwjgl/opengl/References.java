...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/References.class */
class References extends BaseReferences {
    ...
    void copy(References references, int mask) {
        super.copy((BaseReferences) references, mask);
        if ((mask & 2) != 0) {
    ...
    @Override // org.lwjgl.opengl.BaseReferences
    void clear() {
        super.clear();
