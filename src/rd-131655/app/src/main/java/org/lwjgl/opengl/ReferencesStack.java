...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/opengl/ReferencesStack.class */
class ReferencesStack {
    ...
    public References popState(int mask) {
        ...
        this.stack_pos = i - 1;
        References result = referencesArr[i];
        this.references_stack[this.stack_pos].copy(result, mask ^ (-1));
        result.clear();
        return result;
    }
