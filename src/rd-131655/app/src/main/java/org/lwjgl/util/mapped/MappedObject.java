...
/* JADX INFO: loaded from: minecraft-rd-131655.jar:org/lwjgl/util/mapped/MappedObject.class */
public abstract class MappedObject {
    ...
    final void checkRange(int bytes) {
        ...
        if (this.preventGC.capacity() < (this.viewAddress - MemoryUtil.getAddress0(this.preventGC)) + ((long) bytes)) {
